...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        tmp = [[NSUserDefaults standardUserDefaults] integerForKey:@"med highscore"];
...
-(void)continueSequence{
    ...
    if (([sequence count ]-1) % 2 == 0 && ([sequence count]-1)!=0) {
...
-(void) endGameWithMessage:(NSString*) message {
    ...
    if (sequence.count-1 > tmp)
        [[NSUserDefaults standardUserDefaults] setInteger:sequence.count-1 forKey:@"med highscore"];

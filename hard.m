...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        tmp = [[NSUserDefaults standardUserDefaults] integerForKey:@"hard highscore"];
...
-(void) endGameWithMessage:(NSString*) message {
    ...
    if (sequence.count-1 > tmp)
        [[NSUserDefaults standardUserDefaults] setInteger:sequence.count-1 forKey:@"hard highscore"];
